...
T = 25
(c,c0) = p1.average_perceptron(val_bow_features, val_labels, T)

classify_array_test = p1.classify(test_bow_features,c,c0)
test_accuracy = p1.accuracy(classify_array_test,test_labels)
print(test_accuracy)
#-------------------------------------------------------------------------------
